...
with open(fasta_name) as fin:
    ...
    for index, mutation in mutated_bracket.iterrows():
            ...
            for protein in protein_list:
                if protein.find(original) != -1:
                    ...
                    final_sequence_1 = protein.replace(original, modified)
                    ...
                    fasta_protein_write = (
                        ...
                        .format(str(str(protein_index).zfill(3)) + "_" + str(n)))
                    protein_index += 1
    ...
    protein_index, write_list = write_append(seq_dict, write_list, protein_list, split_list, protein_index)
    protein_index, write_list = write_append(no_brac_gene_dict, write_list, protein_list, split_list, protein_index)

with open(fasta_name, "a") as fout:
